...
Vector4 leftfoot;
Vector4 rightfoot;
float previous_left_foot = 0;
float previous_right_foot = 0;
...
void initialize(){
	...
	s_hand_right_x.open("right_hand_x.txt");
	s_hand_right_y.open("right_hand_y.txt");
	s_hand_right_z.open("right_hand_z.txt");
	s_foot_left_y.open("left_foot_y.txt");
	s_foot_right_y.open("right_foot_y.txt");
...
{    
	...
	/// Ath the top is a stream for each parameter,  ////////////////////////
	//  as well as a guide for which number to use for each ///////////////////////
	/////////////////////////////////////////////////////////////////////////

	lefthand = skel.SkeletonPositions[7];
	righthand = skel.SkeletonPositions[8];
	leftfoot = skel.SkeletonPositions[15];
	rightfoot = skel.SkeletonPositions[19];

	s_hand_left_x << lefthand.x << endl;
	s_hand_left_y << lefthand.y << endl;
	s_hand_left_z << lefthand.z << endl;

	s_hand_right_x << righthand.x << endl;
	s_hand_right_y << righthand.y << endl;
	//s_hand_right_z << righthand.z << endl;

	//s_foot_left_y << leftfoot.y << endl;
	//s_foot_right_y << rightfoot.y << endl;
	...
	if(leftfoot.y <= -.5){
		 //Note On: 144, 64, 90
		if(previous_left_foot <= -.5){
			message[0] = 144;
			message[1] = 74; ////// BANG
			message[2] = 90;
			midiout->sendMessage( &message );
		}
		//else if(previous_left_foot > -.49){
		else{
			message[0] = 144;
			message[1] = 75; ////// BANG
			message[2] = 90;
	...
	if(rightfoot.y <= -.49){
		 //Note On: 144, 64, 90
		if(previous_right_foot <= -.49){
			message[0] = 144;
			message[1] = 74; ////// BANG
			message[2] = 90;
			midiout->sendMessage( &message );
		}
		else if(previous_right_foot > -.49){
			message[0] = 144;
			message[1] = 75; ////// BANG
			message[2] = 90;
			midiout->sendMessage( &message );
	...
	*/
	...
	if(righthand.x > .1 && righthand.x <= .11625){
		 //Note On: 144, 64, 90
		message[0] = 144;
		message[1] = 60; ///// C4
		message[2] = 90;
	...
	if(righthand.x > .1325 && righthand.x <= .14875){
		 //Note On: 144, 64, 90
		message[0] = 144;
		message[1] = 62; ///// D4
		message[2] = 90;
	...
	if(righthand.x > .14875 && righthand.x <= .16125){
		 //Note On: 144, 64, 90
		message[0] = 144;
		message[1] = 64; ///// E4
		message[2] = 90;
	...
	if(righthand.x > .16125 && righthand.x <= .17375){
		 //Note On: 144, 64, 90
		message[0] = 144;
		message[1] = 65; ///// F4
		message[2] = 90;
	...
	if(righthand.x > .17375 && righthand.x <= .18625){
		 //Note On: 144, 64, 90
		message[0] = 144;
		message[1] = 67; ///// G4
		message[2] = 90;
	...
	if(righthand.x > .18625 && righthand.x <= .19875){
		 //Note On: 144, 64, 90
		message[0] = 144;
		message[1] = 69; ///// A4
		message[2] = 90;
	...
	if(righthand.x > .19875 && righthand.x <= .21125){
		 //Note On: 144, 64, 90
		message[0] = 144;
		message[1] = 71; ///// B4
		message[2] = 90;
	...
	if(righthand.x > .21125 && righthand.x <= .22375){
		 //Note On: 144, 64, 90
		message[0] = 144;
		message[1] = 72; ///// C4
		message[2] = 90;
	...
	if(lefthand.y > 0 && lefthand.y <= .1){
		message[0] = 144;
		message[1] = 2; ////
		message[2] = 65;
		midiout->sendMessage( &message );
	}
	if(lefthand.y > .1 && lefthand.y <= .2){
		message[0] = 144;
		message[1] = 3; ////
		message[2] = 65;
		midiout->sendMessage( &message );
	}
	if(lefthand.y > .2 && lefthand.y <= .3){
		message[0] = 144;
		message[1] = 4; ////
		message[2] = 65;
		midiout->sendMessage( &message );
	}
	if(lefthand.y > .3 && lefthand.y <= .4){
		message[0] = 144;
		message[1] = 5; ////
		message[2] = 65;
		midiout->sendMessage( &message );
	}
	if(lefthand.y > .4 && lefthand.y <= .5){
		message[0] = 144;
		message[1] = 6; ////
		message[2] = 65;
		midiout->sendMessage( &message );
	}
	if(lefthand.y > .5 && lefthand.y <= .6){
		message[0] = 144;
		message[1] = 7; ////
		message[2] = 65;
		midiout->sendMessage( &message );
	}
	if(lefthand.y > .6 && lefthand.y <= .7){
		message[0] = 144;
		message[1] = 8; ////high
		message[2] = 65;
		midiout->sendMessage( &message );
	...
	if(lefthand.z > 2.6){
		message[0] = 144;
		message[1] = 21; ////bassey filter
		message[2] = 65;
		midiout->sendMessage( &message );
	}
	if(lefthand.z <= 2.6 && lefthand.z > 2.5){
		message[0] = 144;
		message[1] = 22; ////
		message[2] = 65;
		midiout->sendMessage( &message );
	}
	if(lefthand.z <= 2.5 && lefthand.z > 2.4){
		message[0] = 144;
		message[1] = 23; ////
		message[2] = 65;
		midiout->sendMessage( &message );
	}
	if(lefthand.z <= 2.4 && lefthand.z > 2.3){
		message[0] = 144;
		message[1] = 24; ////
		message[2] = 65;
		midiout->sendMessage( &message );
	}
	if(lefthand.z <= 2.3 && lefthand.z > 2.2){
		message[0] = 144;
		message[1] = 25; ////
		message[2] = 65;
		midiout->sendMessage( &message );
	}
	if(lefthand.z <= 2.2 && lefthand.z > 2.1){
		message[0] = 144;
		message[1] = 26; ////
		message[2] = 65;
		midiout->sendMessage( &message );
	}
	if(lefthand.z <= 2.1 && lefthand.z > 2.0){
		message[0] = 144;
		message[1] = 27; ////
		message[2] = 65;
		midiout->sendMessage( &message );
	}
	if(lefthand.z <= 2.0 && lefthand.z > 1.9){
		message[0] = 144;
		message[1] = 28; ////
		message[2] = 65;
		midiout->sendMessage( &message );
	...
	if (righthand.y > .35 && righthand.y <= .37){
		message[0] = 144;
		message[1] = 91; ////
		message[2] = 65;
		midiout->sendMessage(&message);
	}
	if (righthand.y > .37 &&righthand.y <= .39){
		message[0] = 144;
		message[1] = 92; ////
		message[2] = 65;
		midiout->sendMessage(&message);
	}
	if (righthand.y > .39 && righthand.y <= .41){
		message[0] = 144;
		message[1] = 94; ////
		message[2] = 65;
		midiout->sendMessage(&message);
	}
	if (righthand.y > .41 && righthand.y <= .43){
		message[0] = 144;
		message[1] = 95; ////
		message[2] = 65;
		midiout->sendMessage(&message);
	}
	if (righthand.y > .43 && righthand.y <= .45){
		message[0] = 144;
		message[1] = 96; ////
		message[2] = 65;
		midiout->sendMessage(&message);
	}
	if (righthand.y > .45 && righthand.y <= .47){
		message[0] = 144;
		message[1] = 97; ////
		message[2] = 65;
		midiout->sendMessage(&message);
	}
	if (righthand.y > .47 && righthand.y <= .49){
		message[0] = 144;
		message[1] = 98; ////high
		message[2] = 65;
		midiout->sendMessage(&message);
	...
	if(righthand.y >= .60 && righthand.y < .605){
		message[0] = 144;
		message[1] = 91; ////
		message[2] = 65;
		midiout->sendMessage( &message );
	}
	if(righthand.y >= .605 && righthand.y <= .61){
		message[0] = 144;
		message[1] = 93; ////
		message[2] = 65;
		midiout->sendMessage( &message );
	}
	if(righthand.y >= .615 && righthand.y <= .62){
		message[0] = 144;
		message[1] = 94; ////
		message[2] = 65;
		midiout->sendMessage( &message );
	}
	if(righthand.y > .625 && righthand.y <= .63){
		message[0] = 144;
		message[1] = 95; ////
		message[2] = 65;
		midiout->sendMessage( &message );
	}
	if(righthand.y > .635 && righthand.y <= .64){
		message[0] = 144;
		message[1] = 96; ////
		message[2] = 65;
		midiout->sendMessage( &message );
	}
	if(righthand.y > .645 && righthand.y <= .65){
		message[0] = 144;
		message[1] = 97; ////
		message[2] = 65;
		midiout->sendMessage( &message );
	...
	previous_left_foot = leftfoot.y;
	previous_right_foot = rightfoot.y;
